...
public class ProductController {
    ...
    @GetMapping("/find-all")
    public List<Product> findAllProducts(){return productService.findAll();}
    ...
    @PostMapping("/create")
    public void save(@RequestBody Product product){ productService.createNewProduct(product);}

    @PostMapping("/delete")
    public void delete(@RequestBody Product product){ productService.deleteGivenProduct(product);}
}