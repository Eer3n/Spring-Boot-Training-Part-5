...
public class BasketController {
    ...
    @GetMapping("/find-all")
    public List<Basket> findAllByBasketProducts(){return basketService.findAll();}

    @GetMapping("/{Id}")
    public Basket findAllById(@PathVariable Long Id){return basketService.findAllById(Id);}
    ...
    @GetMapping("/amount")
    public Basket findAllByAmount(@PathVariable int amount){return basketService.findAllByAmount(amount);}
    ...
    @GetMapping("/buyer")
    public Basket findAllByBuyer(@PathVariable Buyer buyer){return basketService.findAllByBuyer(buyer);}

    @GetMapping("/isEmpty")
    public void isEmpty(@PathVariable Boolean isEmpty){basketService.findAllByIsEmpty(isEmpty);}

    @PostMapping("/addNewItem")
    public void save(@RequestBody Basket basket){ basketService.addNewItem(basket);}

    @PostMapping("/delete")
    public void delete(@RequestBody Basket basket){ basketService.deleteSelectedItem(basket);}
}
